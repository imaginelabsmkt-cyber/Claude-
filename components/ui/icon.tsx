...
/**
 * Conjunto de ícones de linha (estilo Lucide), SVG inline, sem dependência
 * externa. Mesma linguagem visual do menu (nav-icon), para usar em cards,
 * cabeçalhos e botões no lugar de emojis.
 */
const PATHS: Record<string, string> = {
  ...
  scissors:
    "M6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM20 4 8.5 15.5M14.5 14.5 20 20M8.5 8.5 12 12",
  edit:
  ...
  list: "M8 6h11M8 12h11M8 18h11M3 6h.01M3 12h.01M3 18h.01",
  folder:
  ...
  sparkles:
    "M12 3l1.6 4.8L18.5 9.5l-4.9 1.7L12 16l-1.6-4.8L5.5 9.5l4.9-1.7zM19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8z",
  chart:
    "M3 3v18h18M7 15l3-4 3 3 4-6",
  report:
    "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M9 13v4M12 11v6M15 15v2",
};
...
/** Renderiza um ícone de linha pelo nome. Herda a cor (currentColor). */
export function Icon({ nome, ...props }: IconProps) {
  const caminho = PATHS[nome] ?? PATHS.file;
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
